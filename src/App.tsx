    ...
    <div ref={scrollRef} style={{ width: '100%', background: 'white', position: 'relative' }}>
      ...
      <nav className="navbar">
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
          <div className="secular" style={{ color: '#2563EB', fontSize: '24px', fontWeight: '400' }}>
            My Hostel Online
          </div>
          
          <div className="nav-links" style={{ display: 'flex', gap: '40px', alignItems: 'center' }}>
            <div style={{ display: 'flex', gap: '30px' }}>
              <a href="#features" style={{ color: '#4B5563', fontSize: '16px', textDecoration: 'none' }}>Features</a>
              <a href="#benefits" style={{ color: '#4B5563', fontSize: '16px', textDecoration: 'none' }}>Benefits</a>
              <a href="#testimonials" style={{ color: '#4B5563', fontSize: '16px', textDecoration: 'none' }}>Testimonials</a>
              <a href="#contact" style={{ color: '#4B5563', fontSize: '16px', textDecoration: 'none' }}>Contact</a>
            </div>
            <button style={{ 
              padding: '8px 18px', 
              borderRadius: '8px', 
      ...
      <div className={`mobile-menu-overlay ${menuOpen ? 'open' : ''}`}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          <a href="#features" onClick={() => setMenuOpen(false)} style={{ fontSize: '28px', color: '#111827', textDecoration: 'none', fontWeight: '700' }}>Features</a>
          <a href="#benefits" onClick={() => setMenuOpen(false)} style={{ fontSize: '28px', color: '#111827', textDecoration: 'none', fontWeight: '700' }}>Benefits</a>
          <a href="#testimonials" onClick={() => setMenuOpen(false)} style={{ fontSize: '28px', color: '#111827', textDecoration: 'none', fontWeight: '700' }}>Testimonials</a>
          <a href="#contact" onClick={() => setMenuOpen(false)} style={{ fontSize: '28px', color: '#111827', textDecoration: 'none', fontWeight: '700' }}>Contact</a>
        </div>
        <button className="btn-primary" style={{ marginTop: '40px', height: '60px', fontSize: '18px' }}>Contact Sales</button>
      </div>

      {/* 2. HERO SECTION */}
      <section style={{ padding: '140px 0 80px' }} className="animate-fade-in hero-grid">
        <div className="container hero-grid" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.2fr) minmax(0, 1fr)', gap: '60px', alignItems: 'center' }}>
          <div className="hero-content">
            ...
            <div className="stars-row" style={{ display: 'flex', gap: '40px', marginBottom: '40px' }}>
              <div>
            ...
            <h1 style={{ fontSize: '48px', fontWeight: '600', marginBottom: '24px', lineHeight: '1.1' }}>
              Hostel Management for <br/><span style={{ color: '#3B82F6' }}>Modern Teams</span>
            </h1>
            
            <p style={{ color: '#252422', fontSize: '18px', marginBottom: '40px', maxWidth: '500px', lineHeight: '1.6' }}>
              Equipment management built for teams who need to know where everything is, who has it, and when it&apos;s available.
            </p>

            <button className="btn-primary" style={{ height: '54px', width: '160px', fontSize: '16px' }}>Contact Sales</button>
      ...
      {/* 3. FEATURES SECTION */}
      <section id="features" style={{ background: '#F3F8FE', padding: '120px 0' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '100px' }} className="animate-on-scroll">
          ...
          <FeatureBlock 
            ...
            image="https://placehold.co/584x380/3B82F6/white?text=Digital+Guest+Check-In"
            icon={<RegIcon />}
            reverse={true}
          />
          ...
          <FeatureBlock 
            ...
            image="https://placehold.co/584x380/0EA5E9/white?text=Integrated+Payment+Hub"
            icon={<PayIcon />}
            reverse={false}
          />
        </div>
      ...
      {/* 5. IN ACTION SECTION */}
      <section id="action" style={{ padding: '120px 0' }}>
        <div className="container">
          ...
          <div className="action-grid animate-on-scroll" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px', marginTop: '60px' }}>
            <ActionCard icon={<InterfaceIcon />} color="#DBEAFE" title="Intuitive Interface" text="Clean, modern design that's easy to navigate for all staff members" />
            <ActionCard icon={<MobileIcon />} color="#DCFCE7" title="Mobile Responsive" text="Access your dashboard from any device, anywhere, anytime" />
            <ActionCard icon={<AnalyticIcon />} color="#F3E8FF" title="Advanced Analytics" text="Detailed insights and reports to optimize your operations" />
            <ActionCard icon={<SecureIcon />} color="#FFEDD5" title="Secure & Reliable" text="Enterprise-grade security with 99.9% uptime guarantee" />
          </div>
        </div>
      </section>

      {/* 6. TESTIMONIALS */}
      <section id="testimonials" style={{ background: 'linear-gradient(135deg, #F8FAFC 0%, #EFF6FF 100%)', padding: '120px 0' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '80px' }} className="animate-on-scroll">
          ...
          <div className="testimonial-grid animate-on-scroll" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '30px' }}>
            <TestimonialCard 
              name="Kojo Mathews"
          ...
          <div style={{ marginTop: '80px', textAlign: 'center' }} className="animate-on-scroll">
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '24px', padding: '12px 40px', background: 'rgba(255, 255, 255, 0.7)', borderRadius: '9999px', border: '1px solid #E2E8F0', backdropFilter: 'blur(10px)' }}>
               <div style={{ fontSize: '20px', fontWeight: '600', color: '#111827' }}>4.9/5 <span style={{ fontWeight: '400', color: '#4B5563', fontSize: '18px' }}>Average Rating</span></div>
               <div style={{ width: '1px', height: '24px', background: '#E2E8F0' }}></div>
               <div style={{ fontSize: '18px', color: '#4B5563', fontWeight: '500' }}>500+ Happy Customers</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* 7. TRANSFORM SECTION */}
      <section id="contact" style={{ background: 'linear-gradient(135deg, #0F172A 0%, #1E3A8A 50%, #312E81 100%)', color: 'white', padding: '120px 0' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '80px' }} className="animate-on-scroll">
            ...
            <h2 style={{ fontSize: '64px', fontWeight: '700', lineHeight: 1.1, marginBottom: '24px' }}>Transform Your Hostel <span style={{ color: '#60A5FA' }}>Today</span></h2>
            <p style={{ color: '#DBEAFE', fontSize: '20px', maxWidth: '700px', margin: '0 auto', lineHeight: '1.6' }}>Join hundreds of successful hostel managers who revolutionized their operations with MyHostelOnline.</p>
          </div>
            ...
            <div style={{ background: 'rgba(255, 255, 255, 0.05)', border: '1px solid rgba(255, 255, 255, 0.15)', borderRadius: '24px', padding: '48px', backdropFilter: 'blur(20px)' }}>
              ...
              <form style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                   <div>
                     <label style={{ color: '#DBEAFE', fontSize: '14px', display: 'block', marginBottom: '8px' }}>Full Name *</label>
                     <input type="text" className="input-field" placeholder="Kojo Mathews" />
                   </div>
                   <div>
                     <label style={{ color: '#DBEAFE', fontSize: '14px', display: 'block', marginBottom: '8px' }}>Email Address *</label>
                     <input type="email" className="input-field" placeholder="kojo@hostel.com" />
                   </div>
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                   <div>
                     <label style={{ color: '#DBEAFE', fontSize: '14px', display: 'block', marginBottom: '8px' }}>Phone Number</label>
                     <input type="text" className="input-field" placeholder="+233 000 0000" />
                   </div>
                   <div>
                     <label style={{ color: '#DBEAFE', fontSize: '14px', display: 'block', marginBottom: '8px' }}>Hostel Name</label>
                     <input type="text" className="input-field" placeholder="Elite Dorms" />
                   </div>
                </div>
                <div>
                  <label style={{ color: '#DBEAFE', fontSize: '14px', display: 'block', marginBottom: '8px' }}>Message Details</label>
      ...
      <footer style={{ background: '#0F172A', color: 'white', padding: '100px 0 60px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="container">
          <div className="footer-grid" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1.2fr', gap: '80px', marginBottom: '100px' }}>
            <div>
              <div className="secular" style={{ color: '#60A5FA', fontSize: '28px', marginBottom: '24px' }}>Hostel Manager</div>
              <p style={{ color: '#9CA3AF', fontSize: '16px', lineHeight: '1.7', maxWidth: '440px' }}>
                The complete hostel management solution for modern administrators. Streamline operations, maximize revenue, and enhance your digital guest experience.
              </p>
              <div style={{ display: 'flex', gap: '20px', marginTop: '40px' }}>
                {[...Array(4)].map((_, i) => (
                  <div key={i} style={{ width: '44px', height: '44px', background: 'rgba(255,255,255,0.05)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', transition: '0.3s' }}
            ...
            <div>
              <h4 style={{ fontSize: '18px', fontWeight: '600', marginBottom: '32px' }}>Product</h4>
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '16px', color: '#9CA3AF' }}>
            ...
            <div>
              <h4 style={{ fontSize: '18px', fontWeight: '600', marginBottom: '32px' }}>Support</h4>
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '16px', color: '#9CA3AF' }}>
                <li style={{ cursor: 'pointer' }}>Help Center</li>
                <li style={{ cursor: 'pointer' }}>Contact Us</li>
                <li style={{ cursor: 'pointer' }}>Training Webinars</li>
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '32px', color: '#64748B', fontSize: '14px' }}>
...
const FeatureBlock = ({ title, desc, points, image, icon, reverse }: any) => (
  <div className={`animate-on-scroll feature-block ${reverse ? 'reverse' : ''}`} style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1.1fr)', gap: '100px', alignItems: 'center', marginBottom: '120px', direction: reverse ? 'rtl' : 'ltr' }}>
...
const ActionCard = ({ icon, color, title, text }: any) => (
  <div className="feature-card" style={{ background: 'white', padding: '32px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.03)', textAlign: 'center', border: '1px solid #F1F5F9' }}>
...
const TestimonialCard = ({ name, role, text }: any) => (
  <div style={{ background: 'white', padding: '40px', borderRadius: '24px', boxShadow: '0 10px 30px rgba(0,0,0,0.02)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', border: '1px solid #F1F5F9' }}>
...
const Slideshow = () => {
  ...
  const slides = [
    { url: 'https://placehold.co/1216x400/0F172A/white?text=Main+SaaS+Dashboard', title: 'Payment & Billing Center', desc: 'Track payments, generate invoices, and manage finances' },
    { url: 'https://placehold.co/1216x400/1E40AF/white?text=Staff+Tasks+Management', title: 'Staff Operations', desc: 'Schedule shifts, assign tasks, and track performance' },
    { url: 'https://placehold.co/1216x400/1D4ED8/white?text=Inventory+and+Equipment', title: 'Asset Tracking', desc: 'Real-time inventory for linens, furniture, and kitchen supplies' },
    { url: 'https://placehold.co/1216x400/2563EB/white?text=Guest+Engagement+Hub', title: 'Guest Engagement', desc: 'Manage reviews, loyalty programs, and communication' }
  ];
...
const SocialIcon = ({index}:any) => {
  ...
  return <svg width="20" height="20" fill="none" stroke="white" strokeWidth="2">{icons[index]}</svg>;
}
